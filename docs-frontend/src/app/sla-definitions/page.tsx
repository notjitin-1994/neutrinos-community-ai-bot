  ...
  return (
    <div className="flex flex-col gap-8 animate-fade-in-up opacity-0">
      ...
      <div className="glass-panel p-8 md:p-12">
        <h1 className="text-3xl font-bold mb-4">SLA & Answered Definitions</h1>
        <p className="text-white/60 mb-8">Detailed logic for SLA guardrails, grace periods, and idempotent state management in discourse.</p>
